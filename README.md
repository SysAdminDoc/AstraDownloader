...
[![version](https://img.shields.io/badge/version-2.13.0-ff6552)](https://github.com/SysAdminDoc/AstraDownloader/releases)
...
```powershell
py -3.13 -m pytest          # 1189 tests across every core; scratch stays under build/pytest
